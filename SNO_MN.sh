...
EOF
  ...
  wget -q https://github.com/savenode/bootstrap/releases/download/1.0/bootstrap.zip -O /tmp/bootstrap.zip 
  echo
  echo -e "Installing the bootstrap "
  unzip -qqo /tmp/bootstrap.zip -d /root/.savenode/
  sleep 3
...
function important_information() {
 echo
 echo -e "${PURPLE}${BOLD}
   _____ ___ _    _________   ______  ____  ______
  / ___//   | |  / / ____/ | / / __ \/ __ \/ ____/
  \__ \/ /| | | / / __/ /  |/ / / / / / / / __/
 ___/ / ___ | |/ / /___/ /|  / /_/ / /_/ / /___
/____/_/  |_|___/_____/_/ |_/\____/_____/_____/
${NC}
\t    Masternode Script
\t*************************\n\n"
 sleep 3
